 ...
 * @author Shai Almog
 */
public class DashboardStub implements Runnable, WindowListener {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new DashboardStub());
    }
